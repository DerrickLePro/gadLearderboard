...
public class LearnerRecycleAdapter extends RecyclerView.Adapter<LearnerRecycleAdapter.ViewHolder> {
    ...
    private final int mPositionTab;
    private final LayoutInflater mLayoutInflater;

    public LearnerRecycleAdapter(Context context, int positionTab) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (mPositionTab == TAB_LEARNER_HOURS)
            description = learner.getHours() + " " + mContext.getString(R.string.learning_hours) + ", " + learner.getCountry();
        else if (mPositionTab == TAB_SKILL_IQ)
            description = learner.getHours() + " " + mContext.getString(R.string.skill_iq_score) + ", " + learner.getCountry();
